...
export const updateCourseProgress= async(req,res)=>{
    try{
        ...
        if(progress.length==1){
            const update = await courseProgressModel.findByIdAndUpdate(progress[0]._id,{completed},{new:true})
