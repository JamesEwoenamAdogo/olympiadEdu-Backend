...
userRoute.post("/update-profile-picture/:userId",profileImageupload.single("image"),updateProfileImage)
userRoute.post("/update-cover-picture/:userId",coverImageupload.single("coverImage"),updateCoverImage)
